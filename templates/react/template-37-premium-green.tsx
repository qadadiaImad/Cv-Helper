/**
 * TEMPLATE 37 - PREMIUM GREEN
 * Professional resume with green accent line, left sidebar, and skill tags
...
export const Template37: React.FC<UniversalTemplateProps> = ({ data }) => {
  return (
    <div style={{
      width: '100%',
      minHeight: '1200px',
