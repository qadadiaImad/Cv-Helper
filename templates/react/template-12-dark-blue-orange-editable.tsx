    ...
    <div style={{
      ...
      <div style={{
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 0 15px' }}>
          {displayData.skills && displayData.skills.slice(0, 7).map((skill: string, i: number) => {
      ...
      <div style={{
        ...
        <div style={{
          ...
          {displayData.interests && displayData.interests.slice(0, 5).map((interest: any, i: number) => {
            const icons = ['🎨', '📚', '🎬', '🎧', '🎮'];
            return (
              <div key={i} style={{
                display: 'flex',
