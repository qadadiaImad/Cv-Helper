/**
 * TEMPLATE 12: DARK BLUE ORANGE - EDITABLE VERSION
...
export const DarkBlueOrangeEditable: React.FC<EditableTemplateProps> = ({ 
  data, 
  editMode = false,
  editingSection = null,
  onEditSection = () => {},
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Profile Section - Personal Info Editable */}
        {editMode ? (
            ...
            {displayData.skills && displayData.skills.length > 0 && (
              <div style={{
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 0 15px' }}>
                  {displayData.skills.slice(0, 7).map((skill: string, i: number) => {
        ...
        {displayData.interests && displayData.interests.length > 0 && (
          <div style={{
            ...
            <div style={{
              ...
              {displayData.interests.slice(0, 5).map((interest: any, i: number) => {
                const icons = ['🎨', '📚', '🎬', '🎧', '🎮'];
                return (
                  <div key={i} style={{
                    display: 'flex',
