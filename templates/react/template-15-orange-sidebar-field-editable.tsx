/**
 * ORANGE SIDEBAR TEMPLATE - FIELD-LEVEL EDITABLE VERSION
...
export const OrangeSidebarFieldEditable: React.FC<FieldEditableTemplateProps> = ({ 
  data, 
  editMode = false,
  onFieldChange = () => {}
}) => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          width: '100%',
          height: '280px',
          background: data.personal?.photo?.url ? 'transparent' : 'linear-gradient(135deg, #3a3a3a 0%, #2d2d2d 100%)',
          display: 'flex',
          alignItems: 'center',
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            <EditableText
              value={data.personal?.title || 'UI/UX Designer'}
