...
export const TEMPLATE_REGISTRY: TemplateMetadata[] = [
  ...
  },
  {
    id: 'lauren-chen',
    name: 'Lauren Chen',
    description: 'Professional resume with teal header, circular photo, and two-column layout with contact section',
    category: 'modern',
    tags: ['modern', 'teal', 'professional', 'photo', 'two-column', 'clean', 'marketing'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/lauren-chen.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'website', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'gpa'],
      skills: ['skills'],
      custom: ['photo', 'summary', 'projects', 'certifications'],
    },
    features: ['Teal header with uppercase name', 'Circular profile photo', 'Contact section with labels', 'Skills with progress bars', 'Timeline dots for experience'],
    popularity: 90,
    isNew: true,
    complexity: 'medium',
    layout: 'two-column',
    bestFor: ['marketing-professionals', 'digital-marketers', 'modern-professionals', 'communication-roles'],
    compatibility: { atsScore: 87, printOptimized: true, mobileResponsive: true, accessibilityScore: 89 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '18-25 minutes',
  },
  {
    id: 'orange-sidebar-left',
    name: 'Orange Sidebar Left',
    description: 'Professional resume with orange left sidebar, contact icons, and white main content area',
    category: 'modern',
    tags: ['modern', 'orange', 'sidebar', 'professional', 'clean', 'icons', 'two-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/orange-sidebar-left.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'website', 'linkedIn', 'github'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field'],
      skills: ['skills'],
      custom: ['summary', 'projects', 'certifications'],
    },
    features: ['Orange left sidebar', 'Contact icons with circular backgrounds', 'Summary in sidebar', 'Skills list with bullets', 'Clean white main content'],
    popularity: 88,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['marketing-professionals', 'creative-professionals', 'modern-industries', 'digital-roles'],
    compatibility: { atsScore: 86, printOptimized: true, mobileResponsive: true, accessibilityScore: 88 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-22 minutes',
  },
  {
    id: 'slate-yellow',
    name: 'Slate Yellow',
    description: 'Professional resume with yellow photo box, two-column layout, and bordered skill tags',
    category: 'modern',
    tags: ['modern', 'yellow', 'professional', 'clean', 'tags', 'photo', 'two-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/slate-yellow.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'honors'],
      skills: ['skills'],
      custom: ['summary', 'languages', 'certifications'],
    },
    features: ['Yellow photo box in header', 'Contact info with separators', 'Skill tags with yellow borders', 'Two-column layout', 'Blue section headers'],
    popularity: 89,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['administrative-roles', 'office-professionals', 'assistants', 'coordinators', 'modern-professionals'],
    compatibility: { atsScore: 90, printOptimized: true, mobileResponsive: true, accessibilityScore: 91 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '15-20 minutes',
  },
  {
    id: 'bold-yellow',
    name: 'Bold Yellow',
    description: 'Professional resume with dark header, yellow gradient bar, and two-column layout with sidebar',
    category: 'modern',
    tags: ['modern', 'yellow', 'bold', 'professional', 'gradient', 'sidebar', 'two-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/bold-yellow.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
    ...
    features: ['Dark header with name', 'Yellow gradient bar', 'Yellow section headers', 'Left sidebar with contact/education', 'Skills list with bullets'],
    popularity: 91,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['marketing-professionals', 'digital-professionals', 'modern-industries', 'creative-roles', 'communication-professionals'],
    compatibility: { atsScore: 88, printOptimized: true, mobileResponsive: true, accessibilityScore: 90 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-22 minutes',
  },
  {
    id: 'two-column-yellow',
    name: 'Two Column Yellow',
    description: 'Professional resume with circular photo, navy/orange decorative elements, and two-column layout',
    category: 'modern',
    tags: ['modern', 'yellow', 'orange', 'navy', 'photo', 'two-column', 'decorative', 'professional'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/two-column-yellow.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'honors'],
      skills: ['skills'],
      custom: ['photo', 'summary'],
    },
    features: ['Circular profile photo', 'Navy and orange decorative elements', 'Contact icons', 'Skill tags with yellow borders', 'Two-column layout'],
    popularity: 90,
    isNew: true,
    complexity: 'medium',
    layout: 'two-column',
    bestFor: ['administrative-roles', 'assistants', 'coordinators', 'office-professionals', 'modern-professionals'],
    compatibility: { atsScore: 89, printOptimized: true, mobileResponsive: true, accessibilityScore: 90 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '18-25 minutes',
  },
  {
    id: 'advanced-blue',
    name: 'Advanced Blue',
    description: 'Professional resume with blue accents, contact badges, and photo in top-right corner',
    category: 'modern',
    tags: ['modern', 'blue', 'professional', 'badges', 'photo', 'clean', 'single-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/advanced-blue.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'website', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'honors'],
      skills: ['skills'],
      custom: ['photo', 'summary', 'certifications'],
    },
    features: ['Blue contact badges with icons', 'Photo in top-right corner', 'Skill tags with blue background', 'Clean single-column layout', 'Professional typography'],
    popularity: 92,
    isNew: true,
    complexity: 'simple',
    layout: 'single-column',
    bestFor: ['financial-professionals', 'advisors', 'consultants', 'business-professionals', 'executives'],
    compatibility: { atsScore: 93, printOptimized: true, mobileResponsive: true, accessibilityScore: 92 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '15-20 minutes',
  },
  {
    id: 'premium-green',
    name: 'Premium Green',
    description: 'Professional resume with green accent line, left sidebar, and bordered skill tags',
    category: 'modern',
    tags: ['modern', 'green', 'professional', 'sidebar', 'monospace', 'clean', 'two-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/premium-green.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'honors'],
      skills: ['skills'],
      custom: ['summary', 'projects'],
    },
    features: ['Green accent line header', 'Monospace typography', 'Contact icons with borders', 'Bordered skill tags', 'Two-column layout with sidebar'],
    popularity: 89,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['administrative-roles', 'assistants', 'coordinators', 'office-professionals', 'tech-savvy-professionals'],
    compatibility: { atsScore: 91, printOptimized: true, mobileResponsive: true, accessibilityScore: 92 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-20 minutes',
  },
  {
    id: 'pastel-orange',
    name: 'Pastel Orange',
    description: 'Professional resume with pastel beige sidebar, orange name, and rounded skill tags',
    category: 'modern',
    tags: ['modern', 'orange', 'pastel', 'sidebar', 'professional', 'clean', 'two-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/pastel-orange.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'honors', 'coursework', 'gpa'],
      skills: ['skills'],
      custom: ['summary', 'languages', 'certifications', 'awards'],
    },
    features: ['Pastel beige sidebar', 'Orange name and accents', 'Rounded skill tags', 'Contact icons', 'Two-column layout'],
    popularity: 90,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['designers', 'creative-professionals', 'graphic-designers', 'artists', 'modern-professionals'],
    compatibility: { atsScore: 87, printOptimized: true, mobileResponsive: true, accessibilityScore: 89 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '18-25 minutes',
  },
  {
    id: 'hybrid-green',
    name: 'Hybrid Modern Green',
    description: 'Professional resume with green top/bottom bars, skill badges, and clean single-column layout',
    category: 'modern',
    tags: ['modern', 'green', 'professional', 'clean', 'single-column', 'minimal'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/hybrid-green.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'honors', 'gpa'],
      skills: ['skills'],
      custom: ['summary', 'projects', 'certifications'],
    },
    features: ['Green top and bottom bars', 'Right-aligned contact info', 'Green skill badges', 'Clean single-column layout', 'Professional typography'],
    popularity: 91,
    isNew: true,
    complexity: 'simple',
    layout: 'single-column',
    bestFor: ['marketing-professionals', 'digital-professionals', 'modern-industries', 'communication-roles', 'business-professionals'],
  ...
  },
  {
    ...
    description: 'Professional resume with purple gradient header, timeline design, and skill progress bars',
    category: 'modern',
    tags: ['modern', 'purple', 'professional', 'timeline', 'gradient', 'two-column'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/professional-purple.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
    ...
    features: ['Purple gradient header', 'Timeline with circular markers', 'Contact icons with purple circles', 'Skill progress bars', 'Two-column layout'],
    popularity: 93,
    isNew: true,
    complexity: 'medium',
    layout: 'two-column',
  ...
  {
    id: 'unique-orange',
    name: 'Unique Modern Orange',
    description: 'Professional resume with circular monogram, orange accents, and elegant serif typography',
    category: 'modern',
    tags: ['modern', 'orange', 'professional', 'elegant', 'serif', 'two-column', 'monogram'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/unique-orange.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'linkedIn'],
      experience: ['company', 'position', 'period', 'achievements'],
    ...
    features: ['Circular monogram with initials', 'Orange section headings', 'Serif typography', 'Two-column layout', 'Clean and elegant design'],
    popularity: 94,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['marketing-professionals', 'creative-professionals', 'communication-roles', 'business-professionals', 'modern-industries'],
    compatibility: { atsScore: 91, printOptimized: true, mobileResponsive: true, accessibilityScore: 92 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-20 minutes',
  },
  {
    ...
    description: 'Modern resume with teal header, timeline dots, and clean two-column sidebar layout',
    category: 'modern',
    tags: ['modern', 'teal', 'green', 'sidebar', 'timeline', 'professional', 'clean'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/aesthetic-green.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'linkedIn'],
      experience: ['company', 'position', 'period', 'location', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'gpa', 'honors'],
      skills: ['skills'],
      custom: ['summary', 'languages', 'certifications'],
    },
    features: ['Teal header bar', 'Timeline dots for experience', 'Left sidebar layout', 'Gray sidebar background', 'Clean typography'],
    popularity: 95,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['designers', 'creative-professionals', 'marketing-professionals', 'communication-roles', 'modern-industries'],
    compatibility: { atsScore: 89, printOptimized: true, mobileResponsive: true, accessibilityScore: 91 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-22 minutes',
  },
  {
    id: 'modern-blue-hub',
    name: 'Modern Blue Hub',
    description: 'Modern resume with blue background, circular photo, and clean two-column layout',
    category: 'modern',
    tags: ['modern', 'blue', 'photo', 'sidebar', 'professional', 'creative'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/modern-blue-hub.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'photo'],
      experience: ['company', 'position', 'period', 'location', 'achievements'],
      education: ['institution', 'degree', 'year', 'field', 'gpa', 'location'],
      skills: ['skills'],
      custom: ['summary', 'certifications'],
    },
    features: ['Blue gradient background', 'Circular photo', 'Left sidebar layout', 'White text on blue', 'Footer contact bar'],
    popularity: 96,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['designers', 'creative-professionals', 'modern-professionals', 'tech-professionals', 'marketing-professionals'],
    compatibility: { atsScore: 85, printOptimized: true, mobileResponsive: true, accessibilityScore: 88 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '18-25 minutes',
  },
  {
    id: 'dark-yellow-split',
    name: 'Dark Yellow Split',
    description: 'Modern resume with dark blue/yellow split design, circular photo, and diagonal wave accent',
    category: 'creative',
    tags: ['creative', 'modern', 'dark', 'yellow', 'photo', 'diagonal', 'bold'],
    author: 'CV Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    thumbnailPath: '/templates/dark-yellow-split.webp',
    requiredFields: ['name', 'email', 'phone'],
    fieldMap: {
      basic: ['name', 'title', 'email', 'phone', 'location', 'website', 'photo'],
      experience: ['company', 'position', 'period', 'achievements'],
      education: ['institution', 'degree', 'field', 'year'],
      skills: ['skills'],
      custom: ['summary', 'certifications'],
    },
    features: ['Dark navy sidebar', 'Yellow content area', 'Diagonal wave design', 'Circular photo', 'Bold typography'],
    popularity: 97,
    isNew: true,
    complexity: 'medium',
    layout: 'two-column',
    bestFor: ['creative-professionals', 'designers', 'developers', 'modern-professionals', 'tech-professionals'],
