...
export const TEMPLATE_REGISTRY: TemplateMetadata[] = [
  ...
  },
  {
    ...
    description: 'Refactored Atlantic Blue using reusable component architecture - faster template creation',
    category: 'modern',
    tags: ['sidebar', 'photo', 'modern', 'professional', 'blue', 'dark-theme', 'component-based', 'refactored', 'new-architecture'],
    author: 'CV-Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    ...
    complexity: 'medium',
    layout: 'two-column',
    bestFor: ['creative', 'tech', 'modern-industries', 'photo-resume', 'professionals', 'developers'],
    compatibility: { atsScore: 88, printOptimized: true, mobileResponsive: true, accessibilityScore: 90 },
    customization: { colorCustomizable: true, colorVariants: 3, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '20-30 minutes',
  },
  ...
  {
    id: 'executive_refactored',
    name: 'Executive (Component-Based)',
    description: 'Refactored Executive using reusable component architecture - faster template creation',
    category: 'executive',
    tags: ['traditional', 'serif', 'two-column', 'formal', 'executive', 'management', 'component-based', 'refactored'],
    author: 'CV-Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    ...
    features: ['Component-based architecture', 'Centered header', 'Two-column layout', 'Serif typography', 'Professional formatting', 'Reusable organisms'],
    popularity: 93,
    isNew: true,
    complexity: 'simple',
    layout: 'two-column',
    bestFor: ['executives', 'management', 'traditional-industries', 'formal', 'senior-roles', 'developers'],
    compatibility: { atsScore: 95, printOptimized: true, mobileResponsive: true, accessibilityScore: 94 },
    customization: { colorCustomizable: true, colorVariants: 2, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-20 minutes',
  },
  ...
  {
    id: 'mercury_refactored',
    name: 'Mercury (Component-Based)',
    description: 'Refactored Mercury using SectionedLayout and reusable components - easier customization',
    category: 'modern',
    tags: ['centered', 'photo', 'modern', 'clean', 'minimal', 'visual', 'component-based', 'refactored', 'sectioned'],
    author: 'CV-Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    ...
    features: ['Component-based architecture', 'Centered photo', 'Skills as tags', 'Modern aesthetic', 'Language indicators', 'Sectioned layout'],
    popularity: 91,
    isNew: true,
    complexity: 'medium',
    layout: 'single-column',
    bestFor: ['young-professionals', 'creative', 'modern-companies', 'visual-portfolios', 'developers'],
    compatibility: { atsScore: 85, printOptimized: true, mobileResponsive: true, accessibilityScore: 88 },
    customization: { colorCustomizable: true, colorVariants: 4, supportsPhoto: true, fontCustomizable: true },
    estimatedTime: '18-25 minutes',
  },
  ...
  {
    id: 'classic_refactored',
    name: 'Classic (Component-Based)',
    description: 'Refactored Classic template using SingleColumnLayout and organism components - highly ATS-friendly',
    category: 'classic',
    tags: ['traditional', 'serif', 'right-aligned', 'classic', 'professional', 'ats-friendly', 'component-based', 'refactored'],
    author: 'CV-Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    ...
    features: ['Component-based architecture', 'Right-aligned contact', 'Serif font', 'Clean sections', 'ATS-friendly', 'Reusable organisms'],
    popularity: 89,
    isNew: true,
    complexity: 'simple',
    layout: 'single-column',
    bestFor: ['all-industries', 'conservative', 'ats-systems', 'traditional-companies', 'developers'],
    compatibility: { atsScore: 98, printOptimized: true, mobileResponsive: true, accessibilityScore: 96 },
    customization: { colorCustomizable: true, colorVariants: 2, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '12-18 minutes',
  },
  ...
  {
    id: 'harvard_refactored',
    name: 'Harvard (Component-Based)',
    description: 'Refactored Harvard academic template - education-first with component architecture',
    category: 'classic',
    tags: ['academic', 'minimal', 'education-first', 'research', 'simple', 'students', 'component-based', 'refactored'],
    author: 'CV-Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    ...
    features: ['Component-based architecture', 'Education first', 'Categorized skills', 'Research-friendly', 'Minimal design', 'Reusable organisms'],
    popularity: 86,
    isNew: true,
    complexity: 'simple',
    layout: 'single-column',
    bestFor: ['students', 'recent-graduates', 'academic-positions', 'research-roles', 'developers'],
    compatibility: { atsScore: 94, printOptimized: true, mobileResponsive: true, accessibilityScore: 95 },
    customization: { colorCustomizable: true, colorVariants: 2, supportsPhoto: false, fontCustomizable: true },
    estimatedTime: '15-20 minutes',
  },
  ...
  {
    id: 'evergreen_refactored',
    name: 'Evergreen (Component-Based)',
    description: 'Refactored Evergreen with component architecture - dark header and modular sections',
    category: 'modern',
    tags: ['modern', 'two-column', 'progress-bars', 'photo', 'professional', 'tech', 'component-based', 'refactored'],
    author: 'CV-Helper',
    license: 'MIT',
    type: 'react',
    hidden: false,
    ...
    features: ['Component-based architecture', 'Dark teal header', 'Skill progress bars', 'Two-column layout', 'Photo integrated', 'Reusable organisms'],
    popularity: 89,
    isNew: true,
    complexity: 'medium',
    layout: 'two-column',
