...
import { extractTextFromImagesWithVision, normalizeText } from '@/lib/parse';
import { toCleanResume } from '@/lib/clean';
import { structureCvTextWithAI } from '@/lib/structure_ai';
import { createHash } from 'crypto';
import { ResumeJSON } from '@/lib/schema';
import { sanitizeResumeForSchema } from '@/lib/sanitize';
import { SYSTEM_PROMPT } from '@/lib/prompt';
import { computeResumeDiff, buildNarrativeFromDiff } from '@/lib/diff';
import { isOpenRouterEnabled, getConfiguredModel, getPricingForModel, getDefaultPricing, isJudgeEnabled, getJudgeModel } from '@/config/models';

// Configuration OpenAI sera créée dynamiquement
import { getVerbs, filterForATS, ACTION_VERB_CATEGORIES } from '@/src/hr/actionVerbs';
import { callWithFallbackChat } from '@/Integration/orchestrator';
