...
export const CV1Template: React.FC<UniversalTemplateProps> = ({ data }) => (
  <div style={{
    width: '850px',
    minHeight: '1200px',
    background: '#ffffff',
        ...
        <section style={{ marginBottom: '25px' }}>
          ...
          {data.experience.map((exp, i) => (
            <div key={i} style={{ marginBottom: '18px' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, fontSize: '10px', color: '#666', lineHeight: 1.7 }}>
                {exp.achievements.map((ach, j) => (
                  <li key={j} style={{ marginBottom: '5px', paddingLeft: '15px', position: 'relative' }}>
